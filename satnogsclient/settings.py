...
API_TOKEN = '0' #'042db91b245444b5abc32a6bd7368223c6b223e7' #environ.get('SATNOGS_API_TOKEN', None)
GROUND_STATION_ID = '0' #'48' #_cast_or_none(int, environ.get('SATNOGS_STATION_ID', None))
GROUND_STATION_LAT = '0' #'35.308' #_cast_or_none(float, environ.get('SATNOGS_STATION_LAT', None))
GROUND_STATION_LON = '0' #'25.084' #_cast_or_none(float, environ.get('SATNOGS_STATION_LON', None))
GROUND_STATION_ELEV = '0' #'79' #_cast_or_none(float, environ.get('SATNOGS_STATION_ELEV', None))
